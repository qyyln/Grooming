...
public class mainLian {
    ...
    private HashMap<Integer, ArrayList<ArrayList<Object>>> lightPathRes;
    private ArrayList<ArrayList<Object>> servList;
    ...
    public void autoStopServivice(int currClock) {
        ...
        for (int i = 0; i < servList.size(); i++) {
            if ((int)servList.get(i).get(6) < currClock) {
                stopCount++;
                stopService((int)servList.get(i).get(0), (int)servList.get(i).get(1), (int)servList.get(i).get(3),
                        (ArrayList<ArrayList<Object>>)servList.get(i).get(2), (int)servList.get(i).get(5));
            }
        }
    ...
    * */
    ...
    public void spectrumRelease(int nodei, int nodej, ArrayList<Integer> channelSet, ArrayList<Integer> path){
        ...
        while(channelCount > 0 && spectrumRes.get(nodei *100 + nodej).size() > 0){
            for(int i = 0; i < spectrumRes.get(nodei *100 + nodej).size(); i++){
                ...
                int res2 = (int)spectrumRes.get(nodei *100 + nodej).get(i).get(2);
        ...
        if(SR.equals("SRNP")){
            ...
            for(ArrayList<Object> specRes : spectrumRes.get(nodei * 100 + nodej)){
                if((int)specRes.get(1) - (int)specRes.get(2) > 0){
                    leftChannel = leftChannel + (int)specRes.get(1) - (int)specRes.get(2);
                }
            }
	...
	private void KshortestPath(int currNode, ArrayList<Object> arrayList) {
		// TODO Auto-generated method stub
