...
public class main_test {
	...
	public static void main(String[] args) {
		...
		m.init();
		System.out.println("test spectrumReserve");
		m.spectrumReserve(0, 1, 1, null, "sub");
		System.out.print(m.getSpectrumRes());
		System.out.println();
		m.init();
		m.spectrumReserve(0, 1, 1, channelset, "1");
		System.out.print(m.getSpectrumRes());
		System.out.println();
		m.init();
		m.setSR("SRNP");
		m.spectrumReserve(0, 1, 1, null, "1");
		System.out.print(m.getSpectrumRes());
		System.out.print(m.getSpectrumReserveIntReturn());
